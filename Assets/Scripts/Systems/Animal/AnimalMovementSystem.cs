...
public class AnimalMovementSystem : SystemBase
{
    ...
    protected override void OnUpdate()
    {
        ...
        Dependency = JobHandle.CombineDependencies(Dependency, World.GetExistingSystem<EndFramePhysicsSystem>().FinalJobHandle); //TODO is this necessary?
        ...
        JobHandle fillList = Entities
            ...
            .WithAll<AnimalTag>()
            .ForEach( (int entityInQueryIndex, in AnimalMovementData mvmtData, in Rotation rotation, in Translation translation) => 
            {
        ...
        JobHandle dirJob = Entities
           ...
           }).ScheduleParallel(fillList); // rndJob);
        ...
        JobHandle writeBack = Entities.
            ...
            WithAll<AnimalTag>()
            .ForEach( (int entityInQueryIndex, ref AnimalMovementData animalMovementData, ref Rotation rotation, ref Translation translation) => {
        ...
        animalMvmtData.Dispose();
        animalRotations.Dispose();
        animalTranslations.Dispose();
    }
}